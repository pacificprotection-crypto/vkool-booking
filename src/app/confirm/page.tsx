      ...
      <div className="form-container">
        ...
        <div style={{textAlign:'center',padding:'8px 0 24px'}}>
          ...
          <p style={{fontSize:'14px',color:'#555',lineHeight:'1.6'}}>
            {isPaid
              ? <span>Pago procesado por Wompi.<br/>Enviamos confirmación a <span style={{color:'#aaa'}}>{booking.email}</span></span>
        ...
        <div className="card-dark" style={{textAlign:'center',marginBottom:'16px',padding:'20px'}}>
          ...
          <p style={{fontSize:'12px',color:'#444',marginTop:'8px'}}>Preséntalo al llegar a la sucursal</p>
        </div>
        ...
        <div className="card">
          ...
          {[
            ...
            <div key={label} style={{display:'flex',justifyContent:'space-between',padding:'8px 0',borderBottom:'0.5px solid #1a1a1a',fontSize:'13px'}}>
              <span style={{color:'#555'}}>{label}</span>
              <span style={{color:'#ccc',textAlign:'right',maxWidth:'60%'}}>{val}</span>
            </div>
          ))}
          <div style={{display:'flex',justifyContent:'space-between',padding:'12px 0 0',fontSize:'14px'}}>
            <span style={{color:'#aaa',fontWeight:'500'}}>Total pagado</span>
        ...
        <div className="card">
          ...
          {[
            ...
            <div key={i} style={{display:'flex',gap:'12px',padding:'10px 0',position:'relative'}}>
              {i < arr.length - 1 && (
                <div style={{position:'absolute',left:'9px',top:'26px',bottom:'-10px',width:'0.5px',background:'#2a2a2a'}} />
              )}
              <div style={{
              ...
              <div>
                <div style={{fontSize:'13px',color:'#ccc',fontWeight:'500'}}>{item.title}</div>
  ...
  return (
    <div className="page-wrapper" style={{justifyContent:'center',paddingTop:'60px'}}>
      <div style={{textAlign:'center',maxWidth:'400px',padding:'0 16px'}}>
        ...
        <h2 style={{color:'#fff',marginBottom:'8px'}}>Algo salió mal</h2>
        <p style={{color:'#555',fontSize:'14px',lineHeight:'1.6',marginBottom:'24px'}}>{message}</p>
